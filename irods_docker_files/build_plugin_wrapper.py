...
def build_plugins_in_containers(base_os, image_tag, build_id, plugin_repo, plugin_sha, irods_packages_directory, output_directory):
...
def main():
    ...
    build_plugins_in_containers(args.platform_target, args.image_tag, args.build_id, args.plugin_repo, plugin_sha, args.irods_packages_build_directory, args.output_directory)
